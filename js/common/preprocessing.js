 ...
 * @returns {object[]} The names of the players with at least 2 goals in the tournament
 */
 ...
 *
 * @param {object[]} data The dataset containing all the players in the tournament
 * @returns {object[]} The names of the players with at least 2 assists in the tournament
 */
 ...
 *
 * @param {object[]} data The dataset containing all the players in the tournament
 * @returns {object[]} The names of the players with at least 3 goals + assists in the tournament
 */
